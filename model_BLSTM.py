...
class ActNet(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(150, 100, 3, batch_first=True, dropout=0.5, bidirectional=True)
        self.linear = nn.Sequential(nn.Linear(200, 60),nn.ELU())
   
    def forward(self, inputs):
        features,_ = self.lstm(inputs)    #(256, 100, 200)    
